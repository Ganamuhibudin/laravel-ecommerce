...
Route::group(['prefix' => 'admin', 'middleware' => ['employee'], 'as' => 'admin.' ], function () {
    Route::namespace('Admin')->group(function () {
        Route::group(['middleware' => ['role:admin|superadmin|clerk, guard:employee']], function () {
            ...
            Route::get('reports/orders', 'Reports\ReportController@orders')->name('reports.orders');
            Route::post('reports/orders/generate', 'Reports\ReportController@generateReportOrders')->name('reports.orders.generate');
            Route::get('reports/products', 'Reports\ReportController@products')->name('reports.products');
...
Route::namespace('Front')->group(function () {
    ...
    Route::group(['middleware' => ['auth', 'web']], function () {
        ...
        Route::post('orders/upload', 'AccountsController@uploadBankReceipt')->name('orders.upload');
        Route::post('orders/confirmation/{id}', 'AccountsController@orderConfirmation')->name('orders.confirmation');
        Route::post('orders/retur/{id}', 'AccountsController@returOrder')->name('orders.retur');
        Route::post('orders/cancel/{id}', 'AccountsController@cancelOrder')->name('orders.cancel');
    });
    ...
    Route::post("wishlist/remove/{id}", 'WishlistController@delete')->name('wishlist.remove');
});