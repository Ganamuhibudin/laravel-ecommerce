        ...
        <div class="product-description">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <br>
                    @if (Auth::check())
                        <button onclick="addToWishlist({{ Auth::user()->id }})" class="btn btn-info"><i class="fa fa-heart"></i> Add to wishlist</button>
                    @endif
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function addToWishlist(userID) {
            ...
            $.ajax({
                ...
                data: {customer_id: userID, product_id: productID},
