    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview @if(request()->segment(2) == 'reports') active @endif">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.reports.orders') }}"><i class="fa fa-circle-o"></i> Orders Report</a></li>
                    <li><a href="{{ route('admin.reports.products') }}"><i class="fa fa-circle-o"></i> Best Seller Report</a></li>
                </ul>
            </li>
