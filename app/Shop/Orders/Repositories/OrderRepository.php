...
class OrderRepository extends BaseRepository implements OrderRepositoryInterface
{
     ...
     * @return Collection
     */
    // public function listTopProduct() : Collection
    // {
        // return $this->model->orderedProducts->map(function (OrderProduct $orderProduct) {
        //     $orderProduct->id = $orderProduct->id;
        //     return $orderProduct;
        // });
        // return $this->model->orderproduct->all();
        // return $this->model->orderedProducts->all();
    // }
}
